        ...
        <div class="card-container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    $peserta = mysqli_query($koneksi,"SELECT * FROM peserta WHERE username = '$username'");
                    $data_peserta = mysqli_fetch_assoc($peserta);
                    ?>
                    <div class="profile-card">
                        <div>
                            <span>ID:</span> <?php echo $data_peserta["id_peserta"];?><br>
                            <span>Nama:</span> <?php echo $data_peserta["nama_lengkap"];?><br>
                            <span>Username:</span> <?php echo $data_peserta["username"];?><br>
                            <span>Email:</span> <?php echo $data_peserta["email"];?><br>
                            <span>No Telpon:</span> <?php echo $data_peserta["no_hp"];?><br>
                            <span>Jenis Kelamin:</span> <?php echo $data_peserta["jenis_kelamin"];?><br>
                            <span>Tanggal Lahir:</span> <?php echo $data_peserta["tanggal_lahir"];?><br>
                            <span>Alamat:</span> <?php echo $data_peserta["alamat"];?><br>
                            <span>Nilai:</span> <?php echo $data_peserta["nilai_rata_rata"];?><br>
                            <span>Asal Sekolah:</span> <?php echo $data_peserta["asal_sekolah"];?><br>
                        </div>
                        <div>
                            <div class="btn-group">
                                <a href="form_edit_profil.php?id_peserta=<?php echo $data_peserta["id_peserta"];?>" class="btn btn-warning btn-sm">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
