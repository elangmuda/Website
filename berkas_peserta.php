...
<body>
    ...
    <div class="container">
        <div class="table-container">
            ...
            <a href="form_berkas.php" class="btn btn-primary">Tambah</a>
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    <?php
                        ...
                        $berkas = mysqli_query($koneksi,"SELECT * FROM berkas WHERE username = '$username'");
                        $counter = 1;
                        ?>
                        <?php while($v=mysqli_fetch_array($berkas)):;?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="form_update_berkas.php?id_berkas=<?php echo $v["id_berkas"];?>" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile;?>
