...
<body>
    ...
    <div class="container"> 
        ...
        <h2 class="display-6">Jadwal</h2>
        <div class="text-left mb-3">
            <a href="form_insert_jadwal.php" class="btn btn-primary">Tambah</a>
            ...
            <?php
                ...
                $peserta = mysqli_query($koneksi,"select * from jadwal");
                ?>
                <?php while($v=mysqli_fetch_array($peserta)):;?>
                    <tr>
                        <td><?php echo $v["id_jadwal"];?></td>
                        <td><?php echo $v["id_test"];?></td>
                        <td><?php echo $v["username"];?></td>
                        <td><?php echo $v["tanggal_test"];?></td>
                        <td><?php echo $v["tempat"];?></td>
                        <td><?php echo $v["angkatan"];?></td>

                        <td>
                            <div class="btn-group">
                                <a href="form_update_jadwal.php?id_jadwal=<?php echo $v["id_jadwal"];?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="hapus_jadwal.php?id_jadwal=<?php echo $v["id_jadwal"];?>" class="btn btn-danger btn-sm">Hapus</a>
                            </div>
                        </td>
                    </tr>
                <?php endwhile;?>
        ...
        <div class="text-right mb-2">
                <a href="export_jadwal.php" class="btn btn-primary btn-sm">Cetak Data</a>
            </div>
    </div>
     <!-- Footer -->
     <div class="footer">
