...
<body>
  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark ">
    ...
    <div class="container">
        ...
        <h2 class="display-6 text-center">Data Siswa</h2>
        <!-- <a href="form_insert_peserta.php" class="btn btn-primary">Tambah</a> -->
                ...
                <?php
                    ...
                    <?php while($v=mysqli_fetch_array($peserta)):;?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="update_datadiriadmin.php?id_peserta=<?php echo $v["id_peserta"];?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="hapus_peserta.php?id_peserta=<?php echo $v["id_peserta"];?>" class=" hapus btn btn-danger btn-sm">Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <?php endwhile;?>
