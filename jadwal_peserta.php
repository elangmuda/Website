        ...
        <div class="card-container">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Jadwal Testing</h2>
                ...
                <div class="card-body">
                    ...
                    $peserta = mysqli_query($koneksi,"SELECT * FROM jadwal WHERE username = '$username'");
                    ...
                    if ($data_peserta) {
                        ...
                        <div class="profile-card">
                            <div>
                                ...
                                <span>Tanggal:</span> <?php echo $data_peserta["tanggal_test"];?><br>
                                <span>Tempat:</span> <?php echo $data_peserta["tempat"];?><br>
                            </div>
                            <div>
                            </div>
                        </div>
